...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 7
    answer = largest_number([(-7, -6, -5, -4), (4, 5, 6, 7)])
    print('Expected and actual are: ', expected, answer)
...
def run_test_largest_negative_number():
    ...
    # Test 2:
    expected = -1
    answer = largest_negative_number(([0], [1], [-1]))
    print('Expected and actual are:', expected, answer)

    # Test 3:
    expected = -.00001
    answer = largest_negative_number(([-.1], [-.0001], [-1], [-.00001]))
    print('Expected and actual are:', expected, answer)

    # Test 4:
    expected = -3.4
    answer = largest_negative_number(([-4.2], [-3.4, 0, -7], [-5.6]))
    print('Expected and actual are:', expected, answer)
